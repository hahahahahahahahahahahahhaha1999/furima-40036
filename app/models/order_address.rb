class OrderAddress
  ...
  attr_accessor :user_id, :item_id, :post_code, :prefecture_id, :municipality, :street_address, :building_name, :phone_number, :order, :token
  

  with_options presence: true do
    validates :user_id, :item_id, :post_code, :prefecture_id, :municipality, :street_address, :phone_number
  end
